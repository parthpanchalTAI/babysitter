...
const ActiveHistoryLists = ({
    ...
    return (
        <Container onPress={() => navigation.navigate('ActiveHistoryDetails', { name: name, profile_pic: profile_pic, date: date, time: time })} containerStyle={{ borderWidth: 0, borderRadius: 10, borderColor: '#f2f2f2' }} mpContainer={{ mt: 15 }}>
